...
//		- 항목별 지출 횟수 저장 변수	
		...
		categoryCountSum = gpc.categoryCountup(arrPayReason,daysCount);
		categoryPaymentSum = gpc.categoryPaySum(arrPayReason,arrPaymentDetail,daysCount);
		...
		while(true)
		{
			...
			// 항목별 지출 합계 출력 기능 - 재민
			if(optionSelect == 2) {
				gpc.categoryPayPrint(categoryCountSum, categoryPaymentSum);
